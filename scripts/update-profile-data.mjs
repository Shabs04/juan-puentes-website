...
const headers = {
  ...
  "user-agent": "Mozilla/5.0 (compatible; JuanPuentesSiteBot/1.0; +https://juanpuentesb.github.io/)",
};
...
const getTikTokData = async () => {
  try {
    ...
    return { title: "Juan Puentes on TikTok", error: cleanText(error.message) };
  }
};
